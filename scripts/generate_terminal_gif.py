...
def main() -> None:
    ...
    t.gen_text(text="Core: JavaScript, React, Next.js, Astro", row_num=6)
    t.gen_text(text="Web: SCSS, CSS, HTML", row_num=7)
    t.gen_text(text="Tooling: npm, Git, GitHub Actions", row_num=8)
    t.gen_text(text="Current Focus: Turning wild concepts into polished products", row_num=9)
    t.gen_text(text="GitHub: github.com/Y7XIFIED", row_num=10)
